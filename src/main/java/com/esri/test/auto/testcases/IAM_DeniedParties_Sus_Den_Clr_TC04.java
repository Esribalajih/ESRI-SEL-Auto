...
/**
 * This test case is to check Denied Parties - Existing Account - Suspect > Denied > Cleared functionality
 * 
 * @author udhayasundar
 *
 */
public class IAM_DeniedParties_Sus_Den_Clr_TC04 extends ESRIWrappers {
	@BeforeClass
	@Parameters({ "browser" })
	public void startTestCase(String browser) {
		browserName = browser;
		dataSheetName = "IAM_DeniedParties_Sus_Den_Clr_TC04";
		testCaseName = "IAM_DeniedParties_Sus_Den_Clr_TC04";
		testDescription = "Denied Parties - Existing Account - Suspect > Denied > Cleared - using POM";
	}
