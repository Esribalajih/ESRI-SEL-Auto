...
import com.esri.test.auto.pages.Dist_OktaEsriSigninPage;
import com.esri.test.auto.pages.OutLookEmail;
import com.esri.test.auto.pages.SigninPage;
import com.esri.test.auto.wrappers.ESRIWrappers;

/**
 * This test case is to check Denied Parties - Existing Account - Suspect > Under Review > Denied functionality
 * 
 * @author udhayasundar
 *
 */
public class IAM_DeniedParties_Sus_UR_Den_TC06 extends ESRIWrappers {
	@BeforeClass
	@Parameters({ "browser" })
	public void startTestCase(String browser) {
		browserName = browser;
		dataSheetName = "IAM_DeniedParties_Sus_UR_Den_TC06";
		testCaseName = "IAM_DeniedParties_Sus_UR_Den_TC06";
		testDescription = "Denied Parties - Existing Account - Suspect > Under Review > Denied - using POM";
	}
	...
	public void loginforSuccess(String CSATURL, String CSATUserName, String CSATPassword, String CsatCleared, String CsatDenied, 
		...
		.changeDPStatus(CsatSuspect, CsatUnderReview)
		.clickSaveChangesBtn()
		.clickbsrBackBtn()
		.enterEmail(esriEmail)
		.clickSearchBtn()
		...
		.verifyDPStatus(EsriAcctUsername, changeFirstName, changeLastName, esriEmail, organization)
		.clickDPStatus(EsriAcctUsername, changeFirstName, changeLastName, esriEmail, organization, CsatSuspect)
		.verifySuspectDPStatus(CsatUnderReview)
		.changeDPStatus(CsatUnderReview, CsatDenied)
		.clickSaveChangesBtn()
		.clickbsrBackBtn()
		.enterEmail(esriEmail)
		.clickSearchBtn()
