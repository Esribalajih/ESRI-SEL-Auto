 ...
 *
 */
public class UK_ContactUsPage extends ESRIWrappers {
	public UK_ContactUsPage() throws Throwable {
		waitForPageLoad(10);
	...
	public UK_ContactUsPage verifyContactUSlbl(String data) throws Throwable {
		try {
