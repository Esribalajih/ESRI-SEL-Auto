 ...
 *
 */
public class UK_ArcGISSolutionsPage extends ESRIWrappers {
	public UK_ArcGISSolutionsPage() throws Throwable {
		waitForPageLoad(10);
	...
	public UK_ArcGISSolutionsPage verifyArcGISSolutionslbl(String data) throws Throwable {
		try {
