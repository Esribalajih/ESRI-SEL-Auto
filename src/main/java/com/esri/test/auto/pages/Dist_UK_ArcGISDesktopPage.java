 ...
 *
 */
public class Dist_UK_ArcGISDesktopPage extends ESRIWrappers {
	public Dist_UK_ArcGISDesktopPage() throws Throwable {
		waitForPageLoad(10);
	...
	public Dist_UK_ArcGISDesktopPage verifyArcGISDesktoplbl(String data) throws Throwable {
		try {
