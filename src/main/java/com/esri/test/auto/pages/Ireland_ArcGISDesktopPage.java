 ...
 *
 */
public class Ireland_ArcGISDesktopPage extends ESRIWrappers {
	public Ireland_ArcGISDesktopPage() throws Throwable {
		waitForPageLoad(10);
	...
	public Ireland_ArcGISDesktopPage verifyArcGISforDesktoplbl(String data) throws Throwable {
		try {
