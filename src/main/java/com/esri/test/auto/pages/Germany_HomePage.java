 ...
 *
 */
public class Germany_HomePage extends ESRIWrappers {
	public Germany_HomePage() throws Throwable {
		waitForPageLoad(5);
	...
	// click Branchen Tab
	public Germany_HomePage clickBranchen() throws Throwable {
		try {
	...
	public Germany_HomePage verifyTelekommunikationList(String data) throws Throwable {
		try {
	...
	// click Produkte Tab
	public Germany_HomePage clickProdukte() throws Throwable {
		try {
	...
	public Germany_HomePage verifyArcGIS_PlattformList(String data) throws Throwable {
		try {
			WebDriverWait wait = new WebDriverWait(driver, 10);
			wait.until(ExpectedConditions
	...
	// click Services Tab
	public Germany_HomePage clickServices() throws Throwable {
		try {
	...
	public Germany_HomePage verifySchulungList(String data) throws Throwable {
		try {
			WebDriverWait wait = new WebDriverWait(driver, 10);
			wait.until(ExpectedConditions
	...
	public Germany_HomePage clickGIS_Community() throws Throwable {
		try {
	...
	// verify GeoNet list
	public Germany_HomePage verifyGeoNetList(String data) throws Throwable {
		try {
			WebDriverWait wait = new WebDriverWait(driver, 10);
			wait.until(ExpectedConditions
	...
	// click Über uns Tab
	public Germany_HomePage clickUberuns() throws Throwable {
		try {
	...
	// verify Jobs list
	public Germany_HomePage verifyJobsList(String data) throws Throwable {
		try {
			WebDriverWait wait = new WebDriverWait(driver, 10);
			wait.until(ExpectedConditions
	...
	public Germany_KontaktPage clickKontaktFooter() throws Throwable {
		try {
			clickByXpath(prop.getProperty("disGermanyHome.KontaktFooterlink.xpath"));
		} catch (Exception e) {
			e.printStackTrace();
		}
		return new Germany_KontaktPage();
	}

	// click Rechtliches Footer Link
	public Germany_EsriLizenzbedingungenPage clickRechtlichesFooter() throws Throwable {
		try {
			clickByXpath(prop.getProperty("disGermanyHome.EsriLizenzbedingungenFooterlink.xpath"));
		} catch (Exception e) {
			e.printStackTrace();
		}
		return new Germany_EsriLizenzbedingungenPage();
	}

	// click Impressum Footer link
	public Germany_ImpressumPage clickImpressumFooter() throws Throwable {
		try {
			clickByXpath(prop.getProperty("disGermanyHome.ImpressumFooterlink.xpath"));
		} catch (Exception e) {
			e.printStackTrace();
		}
		return new Germany_ImpressumPage();
	}

	// click Datenschutz Footer link
	public Germany_DatenschutzPage clickDatenschutzFooter() throws Throwable {
		try {
			clickByXpath(prop.getProperty("disGermanyHome.DatenschutzFooterlink.xpath"));
		} catch (Exception e) {
			e.printStackTrace();
		}
		return new Germany_DatenschutzPage();
	}

	// click Home Footer link
	public Germany_HomePage clickHomeFooter() throws Throwable {
		try {
	...
	public Germany_SuchePage clickSearchIcon() throws Throwable {
		try {
			clickById(prop.getProperty("disGermanyHome.searchIcon.id"));
		} catch (Exception e) {
			e.printStackTrace();
		}
		return new Germany_SuchePage();
	}

	// enter the data to search text box
	public Germany_HomePage enterSearchTextBox(String data) throws Throwable {
		try {
	...
	// Verify Branchen Tab is displaying
		public Germany_HomePage verifyBranchenTabDisplaying() throws Throwable {
			try {
