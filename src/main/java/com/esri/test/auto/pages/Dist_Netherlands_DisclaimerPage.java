 ...
 *
 */
public class Dist_Netherlands_DisclaimerPage extends ESRIWrappers {
	public Dist_Netherlands_DisclaimerPage() throws Throwable {
		waitForPageLoad(15);
	...
	public Dist_Netherlands_DisclaimerPage verifyDisclaimerlbl(String data) throws Throwable {
		try {
