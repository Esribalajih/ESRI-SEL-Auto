 ...
 *
 */
public class Ireland_TechSupportPage extends ESRIWrappers {
	public Ireland_TechSupportPage() throws Throwable {
		waitForPageLoad(10);
	...
	public Ireland_TechSupportPage verifyTechnicalSupportlbl(String data) throws Throwable {
		try {
