 ...
 *
 */
public class Dist_Ireland_ContactUsPage extends ESRIWrappers {
	public Dist_Ireland_ContactUsPage() throws Throwable {
		waitForPageLoad(10);
	...
	public Dist_Ireland_ContactUsPage verifyContactUslbl(String data) throws Throwable {
		try {
