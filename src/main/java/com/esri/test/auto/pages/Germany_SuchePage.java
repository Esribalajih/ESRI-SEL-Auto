 ...
 *
 */
public class Germany_SuchePage extends ESRIWrappers {
	public Germany_SuchePage() throws Throwable {
		waitForPageLoad(15);
	...
	public Germany_SuchePage verifyResultsDisplaying() throws Throwable {
		try {
