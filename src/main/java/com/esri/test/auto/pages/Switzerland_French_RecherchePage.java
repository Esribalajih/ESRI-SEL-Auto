 ...
 *
 */
public class Switzerland_French_RecherchePage extends ESRIWrappers {
	public Switzerland_French_RecherchePage() throws Throwable {
		waitForPageLoad(10);
	...
	// Verify result displaying of data for Search
		public Switzerland_French_RecherchePage verifyResultsDisplaying() throws Throwable {
			try {
