 ...
 *
 */
public class Dist_Switzerland_German_SuchePage extends ESRIWrappers {
	public Dist_Switzerland_German_SuchePage() throws Throwable {
		waitForPageLoad(10);
	...
	// Verify result displaying of data for Search
		public Dist_Switzerland_German_SuchePage verifyResultsDisplaying() throws Throwable {
			try {
