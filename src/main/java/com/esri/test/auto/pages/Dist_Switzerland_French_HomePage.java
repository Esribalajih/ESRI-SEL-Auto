 ...
 *
 */
public class Dist_Switzerland_French_HomePage extends ESRIWrappers {

	public Dist_Switzerland_French_HomePage() throws Throwable {
		waitForPageLoad(5);
	...
	// click Secteurs Tab
	public Dist_Switzerland_French_HomePage clickSecteursTab() throws Throwable {
		try {
	...
	public Dist_Switzerland_French_HomePage verifyTelecommunicationLink(String data) throws Throwable {
		try {
			waitForPageLoad(5);
	...
	// click Produits Tab
	public Dist_Switzerland_French_HomePage clickProduitsTab() throws Throwable {
		try {
	...
	public Dist_Switzerland_French_HomePage verifyPlateformeArcGISLink(String data) throws Throwable {
		try {
	...
	// click Services Tab
	public Dist_Switzerland_French_HomePage clickServicesTab() throws Throwable {
		try {
	...
	public Dist_Switzerland_French_HomePage verifyFormationLink(String data) throws Throwable {
		try {
	...
	public Dist_Switzerland_French_HomePage clickCommunauteSIGTab() throws Throwable {
		try {
	...
	// Verify GeoNet link
	public Dist_Switzerland_French_HomePage verifyGeoNetLink(String data) throws Throwable {
		try {
	...
	public Dist_Switzerland_French_HomePage clickAproposdenousTab() throws Throwable {
		try {
	...
	// Verify Postes Link
	public Dist_Switzerland_French_HomePage verifyPostesLink(String data) throws Throwable {
		try {
	...
	public Dist_Switzerland_French_HomePage verifyFrancaisLink(String data) throws Throwable {
		try {
	...
	public Dist_Switzerland_French_RecherchePage clickSearchIcon() throws Throwable {
		try {
			clickById(prop.getProperty("disSwitzFreHome.searchIcon.id"));
		} catch (Exception e) {
			e.printStackTrace();
		}
		return new Dist_Switzerland_French_RecherchePage();
	}

	// enter the data to search text box
	public Dist_Switzerland_French_HomePage enterSearchTextBox(String data) throws Throwable {
		try {
	...
	public Dist_Switzerland_French_ContactPage clickContactFooterlink() throws Throwable {
		try {
			clickByXpath(prop.getProperty("disSwitzFreHome.ContactFooterlink.xpath"));
		} catch (Exception e) {
			e.printStackTrace();
		}
		return new Dist_Switzerland_French_ContactPage();
	}

	// click Informations juridiques footer link
	public Dist_Switzerland_French_CondLicencePage clickInformationsjuridiquesFooterlink() throws Throwable {
		try {
			clickByXpath(prop.getProperty("disSwitzFreHome.InformationsjuridiquesFooterlink.xpath"));
		} catch (Exception e) {
			e.printStackTrace();
		}
		return new Dist_Switzerland_French_CondLicencePage();
	}

	// click Mentions légales footer link
	public Dist_Switzerland_French_MentionsLegalPage clickMentionslegalesFooterlink() throws Throwable {
		try {
			clickByXpath(prop.getProperty("disSwitzFreHome.MentionslegalesFooterlink.xpath"));
		} catch (Exception e) {
			e.printStackTrace();
		}
		return new Dist_Switzerland_French_MentionsLegalPage();
	}

	// click Protection des données footer link
	public Dist_Switzerland_French_ProtectionPage clickProtectiondesdonneesFooterlink() throws Throwable {
		try {
			clickByXpath(prop.getProperty("disSwitzFreHome.ProtectiondesdonneesFooterlink.xpath"));
		} catch (Exception e) {
			e.printStackTrace();
		}
		return new Dist_Switzerland_French_ProtectionPage();
	}

	// click Accueil footer link
	public Dist_Switzerland_French_HomePage clickAccueilFooterlink() throws Throwable {
		try {
