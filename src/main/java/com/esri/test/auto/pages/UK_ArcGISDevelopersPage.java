 ...
 *
 */
public class UK_ArcGISDevelopersPage extends ESRIWrappers {
	public UK_ArcGISDevelopersPage() throws Throwable {
		waitForPageLoad(10);
	...
	public UK_ArcGISDevelopersPage verifyArcGISDeveloperslbl(String data) throws Throwable {
		try {
