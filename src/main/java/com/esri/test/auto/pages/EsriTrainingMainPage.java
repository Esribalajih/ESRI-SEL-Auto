...
public class EsriTrainingMainPage extends ESRIWrappers {
	...
	public EsriTrainingMainPage headerEmbedCode() throws Throwable{
		verifyHeaderEmbedCode(prop.getProperty("Tag.HeaderEmbedCode.xpath"),prop.getProperty("Tag.HeaderEmbedCode.text"));
		return this;
	}
	public EsriTrainingMainPage googleTagManagerForScript() throws Throwable{
	...
	public EsriTrainingMainPage googleTagManagerForNoScript() throws Throwable{
	...
	public EsriTrainingMainPage footerEmbbedCode() throws Throwable{
		verifyFooterEmbedCode(prop.getProperty("Tag.FooterEmbbedCode.xpath"),prop.getProperty("Tag.FooterEmbbedCode.text"));
		return this;
	}
	public EsriTrainingMainPage pardotDataLayerCode() throws Throwable{
