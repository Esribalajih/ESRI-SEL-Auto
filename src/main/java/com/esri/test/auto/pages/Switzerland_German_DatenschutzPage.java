 ...
 *
 */
public class Switzerland_German_DatenschutzPage extends ESRIWrappers {
	public Switzerland_German_DatenschutzPage() throws Throwable {
		waitForPageLoad(10);
	...
	public Switzerland_German_DatenschutzPage verifyDatenschutzlbl(String data) throws Throwable {
		try {
