 ...
 *
 */
public class Dist_Ireland_ArcGISServerPage extends ESRIWrappers {
	public Dist_Ireland_ArcGISServerPage() throws Throwable {
		waitForPageLoad(10);
	...
	public Dist_Ireland_ArcGISServerPage verifyArcGISServerlbl(String data) throws Throwable {
		try {
