 ...
 *
 */
public class India_ServicesPage extends ESRIWrappers {
	public India_ServicesPage() throws Throwable {
		waitForPageLoad(15);
	...
	public India_ServicesPage verifyServiceslbl(String data) throws Throwable {
		try {
