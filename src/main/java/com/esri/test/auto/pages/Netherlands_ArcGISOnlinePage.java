 ...
 *
 */
public class Netherlands_ArcGISOnlinePage extends ESRIWrappers {
	public Netherlands_ArcGISOnlinePage() throws Throwable {
		waitForPageLoad(15);
	...
	public Netherlands_ArcGISOnlinePage verifyArcGISOnlinelbl(String data) throws Throwable {
		try {
