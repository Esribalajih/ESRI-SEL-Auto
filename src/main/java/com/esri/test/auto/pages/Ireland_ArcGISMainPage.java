 ...
 *
 */
public class Ireland_ArcGISMainPage extends ESRIWrappers {
	public Ireland_ArcGISMainPage() throws Throwable {
		waitForPageLoad(10);
	...
	public Ireland_ArcGISMainPage verifyArcGISMainlbl(String data) throws Throwable {
		try {
