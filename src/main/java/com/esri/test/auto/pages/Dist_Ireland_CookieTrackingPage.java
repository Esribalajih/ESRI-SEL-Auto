 ...
 *
 */
public class Dist_Ireland_CookieTrackingPage extends ESRIWrappers {
	public Dist_Ireland_CookieTrackingPage() throws Throwable {
		waitForPageLoad(10);
	...
	public Dist_Ireland_CookieTrackingPage verifyCookieInfolabel(String data) throws Throwable {
		try {
