 ...
 *
 */
public class Netherlands_MarketingPlacePage extends ESRIWrappers {
	public Netherlands_MarketingPlacePage() throws Throwable {
		waitForPageLoad(15);
	...
	public Netherlands_MarketingPlacePage verifyMarketplacelbl(String data) throws Throwable {
		try {
