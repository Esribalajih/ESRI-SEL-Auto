 ...
 *
 */
public class India_LocAnalyticsPage extends ESRIWrappers {
	public India_LocAnalyticsPage() throws Throwable {
		waitForPageLoad(15);
	...
	public India_LocAnalyticsPage verifyLocalAnalyticsllbl(String data) throws Throwable {
		try {
