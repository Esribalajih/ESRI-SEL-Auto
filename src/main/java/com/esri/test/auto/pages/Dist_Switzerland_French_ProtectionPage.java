 ...
 *
 */
public class Dist_Switzerland_French_ProtectionPage extends ESRIWrappers {
	public Dist_Switzerland_French_ProtectionPage() throws Throwable {
		waitForPageLoad(10);
	...
	public Dist_Switzerland_French_ProtectionPage verifyProtectiondesdonneeslbl(String data) throws Throwable {
		try {
