 ...
 *
 */
public class India_ESRIIndNewsPage extends ESRIWrappers {
	public India_ESRIIndNewsPage() throws Throwable {
		waitForPageLoad(15);
	...
	// verify News label
	public India_ESRIIndNewsPage verifyNewslbl(String data) throws Throwable {
		try {
