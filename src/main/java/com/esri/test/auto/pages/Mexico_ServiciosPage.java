 ...
 *
 */
public class Mexico_ServiciosPage extends ESRIWrappers {
	public Mexico_ServiciosPage() throws Throwable {
		waitForPageLoad(10);
	...
	public Mexico_ServiciosPage verifyServiciosySolucioneslbl(String data) throws Throwable {
		try {
