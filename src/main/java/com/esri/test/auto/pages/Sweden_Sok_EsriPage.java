 ...
 *
 */
public class Sweden_Sok_EsriPage extends ESRIWrappers {
	public Sweden_Sok_EsriPage() throws Throwable {
		waitForPageLoad(10);
	...
	// Verify result displaying of data for Search
		public Sweden_Sok_EsriPage verifyResultsDisplaying() throws Throwable {
			try {
