 ...
 *
 */
public class Dist_Netherlands_ZoekenPage extends ESRIWrappers {
	public Dist_Netherlands_ZoekenPage() throws Throwable {
		waitForPageLoad(10);
	...
	// Verify result displaying of data for Search
		public Dist_Netherlands_ZoekenPage verifyResultsDisplaying() throws Throwable {
			try {
