 ...
 *
 */
public class Dist_Rwanda_ContactUsPage extends ESRIWrappers {
	public Dist_Rwanda_ContactUsPage() throws Throwable {
		waitForPageLoad(10);
	...
	public Dist_Rwanda_ContactUsPage verifyContactUslbl(String data) throws Throwable {
		try {
