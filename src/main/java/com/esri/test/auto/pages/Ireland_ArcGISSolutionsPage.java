 ...
 *
 */
public class Ireland_ArcGISSolutionsPage extends ESRIWrappers {
	public Ireland_ArcGISSolutionsPage() throws Throwable {
		waitForPageLoad(10);
	...
	public Ireland_ArcGISSolutionsPage verifyArcGISSolutionlbl(String data) throws Throwable {
		try {
