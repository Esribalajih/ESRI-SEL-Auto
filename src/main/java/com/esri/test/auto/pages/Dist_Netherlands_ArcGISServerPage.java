 ...
 *
 */
public class Dist_Netherlands_ArcGISServerPage extends ESRIWrappers {
	public Dist_Netherlands_ArcGISServerPage() throws Throwable {
		waitForPageLoad(15);
	...
	public Dist_Netherlands_ArcGISServerPage verifyArcGISserverlbl(String data) throws Throwable {
		try {
