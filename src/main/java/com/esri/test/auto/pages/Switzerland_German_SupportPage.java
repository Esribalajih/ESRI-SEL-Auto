 ...
 *
 */
public class Switzerland_German_SupportPage extends ESRIWrappers {
	public Switzerland_German_SupportPage() throws Throwable {
		waitForPageLoad(10);
	...
	public Switzerland_German_SupportPage verifySupportlbl(String data) throws Throwable {
		try {
