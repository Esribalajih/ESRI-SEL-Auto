 ...
 *
 */
public class Dist_Switzerland_German_LizenzbedingungenPage extends ESRIWrappers {
	public Dist_Switzerland_German_LizenzbedingungenPage() throws Throwable {
		waitForPageLoad(10);
	...
	public Dist_Switzerland_German_LizenzbedingungenPage verifyLizenzbedingungenlbl(String data) throws Throwable {
		try {
