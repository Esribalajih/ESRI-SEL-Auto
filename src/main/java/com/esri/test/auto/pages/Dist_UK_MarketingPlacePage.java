 ...
 *
 */
public class Dist_UK_MarketingPlacePage extends ESRIWrappers {
	public Dist_UK_MarketingPlacePage() throws Throwable {
		waitForPageLoad(10);
	...
	public Dist_UK_MarketingPlacePage verifyMarketplacelbl(String data) throws Throwable {
		try {
