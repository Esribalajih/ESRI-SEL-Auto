 ...
 *
 */
public class Dist_Ireland_LegalTermsAndCondPage extends ESRIWrappers {
	public Dist_Ireland_LegalTermsAndCondPage() throws Throwable {
		waitForPageLoad(10);
	...
	public Dist_Ireland_LegalTermsAndCondPage verifyLegalTermCondlbl(String data) throws Throwable {
		try {
