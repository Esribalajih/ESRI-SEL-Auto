 ...
 *
 */
public class Dist_UK_SupportPage extends ESRIWrappers {
	public Dist_UK_SupportPage() throws Throwable {
		waitForPageLoad(10);
	...
	public Dist_UK_SupportPage verifySupportlbl(String data) throws Throwable {
		try {
