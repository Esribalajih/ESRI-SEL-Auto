 ...
 *
 */
public class Dist_Netherlands_AppPage extends ESRIWrappers {
	public Dist_Netherlands_AppPage() throws Throwable {
		waitForPageLoad(15);
	...
	public Dist_Netherlands_AppPage verifyAppslbl(String data) throws Throwable {
		try {
