 ...
 *
 */
public class Dist_Mexico_BuscarPage extends ESRIWrappers {
	public Dist_Mexico_BuscarPage() throws Throwable {
		waitForPageLoad(10);
	...
	// click enter text in search text box
		public Dist_Mexico_BuscarPage enterValueSearchTextBox(String searchData) throws Throwable {
			try {
	...
	public Dist_Mexico_BuscarPage clickSearchIconBtn() throws Throwable {
		try {
	...
	// Verify result displaying of data for Search
		public Dist_Mexico_BuscarPage verifyResultsDisplaying() throws Throwable {
			try {
