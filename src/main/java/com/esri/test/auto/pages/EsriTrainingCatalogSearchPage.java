...
public class EsriTrainingCatalogSearchPage extends ESRIWrappers {
	...
	public EsriTrainingCatalogSearchPage headerEmbedCode() throws Throwable{
		verifyHeaderEmbedCode(prop.getProperty("Tag.HeaderEmbedCode.xpath"),prop.getProperty("Tag.HeaderEmbedCode.text"));
		return this;
	}
	public EsriTrainingCatalogSearchPage googleTagManagerForScript() throws Throwable{
	...
	public EsriTrainingCatalogSearchPage googleTagManagerForNoScript() throws Throwable{
	...
	public EsriTrainingCatalogSearchPage footerEmbbedCode() throws Throwable{
		verifyFooterEmbedCode(prop.getProperty("Tag.FooterEmbbedCode.xpath"),prop.getProperty("Tag.FooterEmbbedCode.text"));
		return this;
	}
	public EsriTrainingCatalogSearchPage pardotDataLayerCode() throws Throwable{
