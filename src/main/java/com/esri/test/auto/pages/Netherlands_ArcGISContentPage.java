 ...
 *
 */
public class Netherlands_ArcGISContentPage extends ESRIWrappers {
	public Netherlands_ArcGISContentPage() throws Throwable {
		waitForPageLoad(15);
	...
	public Netherlands_ArcGISContentPage verifyArcGISContentlbl(String data) throws Throwable {
		try {
