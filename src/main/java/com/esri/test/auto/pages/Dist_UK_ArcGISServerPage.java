 ...
 *
 */
public class Dist_UK_ArcGISServerPage extends ESRIWrappers {
	public Dist_UK_ArcGISServerPage() throws Throwable {
		waitForPageLoad(10);
	...
	public Dist_UK_ArcGISServerPage verifyArcGISServerslbl(String data) throws Throwable {
		try {
