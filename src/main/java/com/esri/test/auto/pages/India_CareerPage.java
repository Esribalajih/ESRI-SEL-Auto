 ...
 *
 */
public class India_CareerPage extends ESRIWrappers {
	public India_CareerPage() throws Throwable {
		waitForPageLoad(15);
	...
	public India_CareerPage verifyCareerslbl(String data) throws Throwable {
		try {
