 ...
 *
 */
public class India_ArcGISForDevPage extends ESRIWrappers {
	public India_ArcGISForDevPage() throws Throwable {
		waitForPageLoad(10);
	...
	public India_ArcGISForDevPage verifyArcGISforDeveloperslbl(String data) throws Throwable {
		try {
