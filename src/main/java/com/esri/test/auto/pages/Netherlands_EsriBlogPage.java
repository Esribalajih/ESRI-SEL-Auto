 ...
 *
 */
public class Netherlands_EsriBlogPage extends ESRIWrappers {
	public Netherlands_EsriBlogPage() throws Throwable {
		waitForPageLoad(15);
	...
	public Netherlands_EsriBlogPage verifyEsriNederlandbloglbl(String data) throws Throwable {
		try {
